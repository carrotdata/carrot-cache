  ...
  public void setUp() {
    ...
    for (int i = 0; i < this.numRecords; i++) {
      ...
      this.format.writeIndex(this.indexBuffer, this.indexBuffer + headerSize + i * this.entrySize,
        this.keys[i], 0, this.keySize, this.values[i], 0, this.valueSize, this.sids[i],
        this.offsets[i], this.lengths[i], this.expire[i]);
      this.format.writeIndex(this.indexBufferMem,
        this.indexBufferMem + headerSize + i * this.entrySize, this.mKeys[i], this.keySize,
        this.mValues[i], this.valueSize, this.sids[i], this.offsets[i], this.lengths[i],
        this.expire[i]);
    }
  }
