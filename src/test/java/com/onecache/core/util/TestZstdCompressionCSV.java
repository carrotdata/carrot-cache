...
public class TestZstdCompressionCSV {
  ...
  public static void main(String[] args) throws IOException {
    ...
    //String file = "/Users/vrodionov/Development/datasets/twitter_sentiments/training.1600000.processed.noemoticon.csv";
  ...
  private static int getTrainingList(DataInputStream dis, List<byte[]> toTrain, long fileSize) throws IOException {
  ...
  @SuppressWarnings("deprecation")
  private static List<byte[]> compress(ZstdCompressCtx context, DataInputStream source, List<Integer> sizes, int group) throws IOException{
    ...
    while((line = source.readLine()) != null) {
      ...
      if (c > prevCounter) {
        prevCounter = c;
        LOG.info("Compressed {} last batch time={}", c * 100_000_000L, System.currentTimeMillis() - prevTime);
