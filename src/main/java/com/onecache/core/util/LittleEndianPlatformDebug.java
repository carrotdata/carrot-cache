...
import static com.onecache.core.util.UnsafeAccess.mallocStats;

public final class LittleEndianPlatformDebug implements Platform {

  LittleEndianPlatformDebug(){}
  ...
  public Platform getNormalVersion() {
    return new LittleEndianPlatform();
  }
