...
/**
 * Format of an index entry (18 bytes): expire - 2 bytes hash - 6 bytes size - 4 bytes sid - 2 bytes
 * offset - 4 bytes
 */
public final class CompactBaseWithExpireIndexFormat extends CompactBaseIndexFormat {
