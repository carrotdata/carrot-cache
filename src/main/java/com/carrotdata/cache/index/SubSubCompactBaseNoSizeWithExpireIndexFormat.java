 ...
 * bytes
 */
public final class SubSubCompactBaseNoSizeWithExpireIndexFormat
    extends SubSubCompactBaseNoSizeIndexFormat {

  public SubSubCompactBaseNoSizeWithExpireIndexFormat() {
    super();
