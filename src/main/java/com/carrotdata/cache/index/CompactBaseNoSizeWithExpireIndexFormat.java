...
/**
 * Format of an index entry (14 bytes): expire - 2 bytes hash - 6 bytes sid - 2 bytes offset - 4
 * bytes
 */
public final class CompactBaseNoSizeWithExpireIndexFormat extends CompactBaseNoSizeIndexFormat {
