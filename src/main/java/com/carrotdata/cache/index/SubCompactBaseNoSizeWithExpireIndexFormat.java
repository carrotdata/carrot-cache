...
/**
 * Format of an index entry (12 bytes): expire - 2 bytes hash - 4 bytes sid - 2 bytes offset - 4
 * bytes
 */
public final class SubCompactBaseNoSizeWithExpireIndexFormat
    extends SubCompactBaseNoSizeIndexFormat {

  public SubCompactBaseNoSizeWithExpireIndexFormat() {
    super();
