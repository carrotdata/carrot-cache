...
public class BaseFileDataReaderOpt implements DataReader {
  @SuppressWarnings("unused")
  private static Logger LOG = LoggerFactory.getLogger(BaseFileDataReaderOpt.class);
